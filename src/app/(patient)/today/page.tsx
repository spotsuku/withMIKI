    ...
    return (
      <>
        ...
        <div className="container">
          ...
          <p className="meta">{ctx.patient.name} さん（アスリート）　<Link href="/food">🍱 食事</Link>　<Link href="/history">📈 推移</Link>　<Link href="/labs">🩸 採血</Link>　<Link href="/media">📷 写真</Link>　<Link href="/mypage">🏠 マイページ</Link></p>
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <p className="meta">{ctx.patient.name} さん　毎日の体調を記録しましょう。　<Link href="/food">🍱 食事</Link>　<Link href="/history">📈 推移</Link>　<Link href="/labs">🩸 採血</Link>　<Link href="/media">📷 写真</Link>　<Link href="/mypage">🏠 マイページ</Link></p>
